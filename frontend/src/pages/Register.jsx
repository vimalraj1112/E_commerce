...
const Register = () => {
    ...
    return (
        <div className="relative min-h-[85vh] flex items-center justify-center px-4 py-16 overflow-hidden">
            ...
            <div className="glow-orb h-72 w-72 -top-10 -right-10 bg-neutral-400/40" />
            <div className="glow-orb h-72 w-72 -bottom-12 -left-12 bg-neutral-300/50" style={{ animationDelay: "5s" }} />
                    ...
                    <div className="p-8 md:p-12 bg-[#e9e7e5]/45 rounded-[2rem]">
                        <motion.div variants={staggerContainer(0.08)} initial="hidden" animate="visible">
                            ...
                            <motion.p variants={fadeUp} className="mt-10 text-center text-sm text-gray-500 font-medium">
                                ...
                                <Link to="/login" className="font-bold text-neutral-900 hover:underline">Log in back</Link>
                            </motion.p>
                        </motion.div>
                    </div>
                </div>
